  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
              ...
              <Card className="hover-lift flex-1">
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      <h4 className="font-semibold">{reviews[currentReviewIndex].name}</h4>
                ...
                <CardContent>
                  <p className="text-sm opacity-80 mb-3 whitespace-pre-line">
                    "{expandedReviews[reviews[currentReviewIndex].id] 
                      ? reviews[currentReviewIndex].full 
                      : reviews[currentReviewIndex].preview}"
                  </p>
                  {reviews[currentReviewIndex].preview !== reviews[currentReviewIndex].full && (
                    <Button 
                      variant="link" 
                      size="sm" 
                      ...
                      onClick={() => setExpandedReviews(prev => ({ 
                        ...prev, 
                        [reviews[currentReviewIndex].id]: !prev[reviews[currentReviewIndex].id] 
                      }))}
                    >
                      {expandedReviews[reviews[currentReviewIndex].id] ? 'Скрыть' : 'Читать полностью'}
                    </Button>
                  )}
                  <p className="text-xs opacity-60 mt-2">{reviews[currentReviewIndex].date}, 2ГИС</p>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 w-16 h-16 rounded-full bg-[#25D366] flex items-center justify-center hover:scale-110 transition-transform shadow-2xl z-50 animate-pulse hover:animate-none"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-24 w-16 h-16 rounded-full bg-[#0088cc] flex items-center justify-center hover:scale-110 transition-transform shadow-2xl z-50 animate-pulse hover:animate-none"
