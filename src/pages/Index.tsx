  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 w-16 h-16 rounded-full bg-[#0088cc] flex items-center justify-center hover:scale-110 transition-transform shadow-2xl z-50 animate-pulse hover:animate-none"
