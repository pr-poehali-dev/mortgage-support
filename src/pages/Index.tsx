            ...
            <Card className="hover-lift">
              ...
              <CardContent>
                <p className="text-sm opacity-80 mb-3">
                  "Читаю ниже столько восторженных отзывов, и это абсолютно заслужено! Наша сделка по ипотеке была не простая, и нам помогло знание своего дела Анастасии..."
                  {expandedReviews['review1'] && (
                    <>
                      <br/><br/>
                ...
                <Button 
                  ...
                  onClick={() => setExpandedReviews(prev => ({ ...prev, review1: !prev.review1 }))}
                >
                  {expandedReviews['review1'] ? 'Скрыть' : 'Читать полностью'}
                </Button>
                <p className="text-xs opacity-60 mt-2">14 октября 2024, 2ГИС</p>
              </CardContent>
            </Card>
            ...
            <Card className="hover-lift">
              <CardHeader>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <h4 className="font-semibold">Клиент МангоДом</h4>
                    <div className="flex gap-1 text-yellow-500">
                      {'⭐'.repeat(5)}
                    </div>
                  </div>
              ...
              <CardContent>
                <p className="text-sm opacity-80 mb-3">
                  "Анастасия, спасибо Вам за ваш труд! Благодаря Вам мы с семьей теперь будем жить в собственном доме!..."
                  {expandedReviews['review2'] && (
                    <>
                      <br/><br/>
                      Вы помогли оперативно выбрать надежного застройщика и оформить ипотеку в очень сжатые сроки))) 🫣
                      <br/><br/>
                ...
                <Button 
                  ...
                  size="sm" 
                  className="p-0 h-auto text-primary"
                  onClick={() => setExpandedReviews(prev => ({ ...prev, review2: !prev.review2 }))}
                >
                  {expandedReviews['review2'] ? 'Скрыть' : 'Читать полностью'}
                </Button>
                <p className="text-xs opacity-60 mt-2">2ГИС</p>
              </CardContent>
            </Card>
