        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <AccordionItem value="item-5" className="border rounded-lg px-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <AccordionContent className="text-muted-foreground">
                Минимальный первоначальный взнос зависит от программы и составляет от 10-15% от стоимости 
                недвижимости. Для некоторых льготных программ требования могут быть выше. Чем больше 
                первоначальный взнос, тем выгоднее условия кредита.
              </AccordionContent>
            </AccordionItem>
